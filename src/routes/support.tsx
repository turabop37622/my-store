...
function SupportPage() {
  ...
  return (
    <main className="min-h-screen bg-background pt-32 md:pt-40 pb-24 overflow-hidden relative">
      ...
      <div className="mx-auto max-w-[1400px] px-4 md:px-10 xl:px-40">
        {/* Hero Section */}
        <div className="max-w-3xl mb-16 md:mb-24">
          <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-secondary text-primary text-[10px] font-medium tracking-wide mb-6 border border-border">
        ...
        <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-4 md:gap-6 mb-24">
          {quickActions.map((item) => (
            ...
            >
              ...
              <h3 className="text-xl font-medium tracking-tight mb-2">{item.label}</h3>
        ...
        <div className="grid lg:grid-cols-12 gap-16 items-start">
          <div className="lg:col-span-4 space-y-4 sticky top-40">
            <h2 className="text-3xl font-normal tracking-tighter flex items-center gap-3">
            ...
            <div className="pt-6">
              <Link 
                to="/contact" 
                className="inline-flex h-12 items-center px-6 rounded-full bg-black text-white text-xs font-medium tracking-wide hover:scale-105 active:scale-95 transition-all"
              >
          ...
          <div className="lg:col-span-8">
            <Accordion type="single" collapsible className="w-full space-y-4">
              {faqs.map((faq, i) => (
                ...
                >
                  <AccordionTrigger className="hover:no-underline font-medium text-left py-7 text-lg group">
                    {faq.q}
                  </AccordionTrigger>
